        ...
        <div className="text-justify">
          ...
          <div className="text-justify">
            ...
            <div className="section">
              <p>
                <b>Lexico: </b> Conjunto de palabras que el lenguaje ofrece a sus usuarios bien sea un lengauje natural
                o artificial.
              </p>
              <p>
                <b>Sintaxis:</b> Conjutno de reglas utilizadas para precisar si una determinada cadena de palabras foram
                una oracion valida.
              </p>
              <pre>
            ...
            <div className="section">
              <ol className="list-decimal list-inside">
                ...
                <li>
                  Verifica si todas las lineas subsiguientes son correctas Alfabeticamente, Lexicamente, Sintaticamente
                  y Semanticamente{' '}
                </li>
                <li>
                  Comunca errores. <br />
            ...
            <div className="section">
              <ol className="list-decimal list-inside">
                ...
                <li>
                  ...
                  Python. El codigo fuente de pypy no se ejecuta de manera interpretativa si no que se traduce a C y
                  luego se ejecuta por separado.
                  <br />
                  Notas:
                  <ol>
            ...
            <div className="section">
              <p>
                Un literal se refiere a datos cuyos valores estan determinados por el literal mismo y se utilizan dentro
                del codigo.
              </p>
            </div>
            ...
            <div className="section">
              <p>
                Hay cuatro operadores que le permite manipular bits de datos individuales. se denomina operadores bit a
                bit. <br />
              </p>
              ...
              <ol className="mx-10 list-disc">
                <li>
                  Los operadores bit a bit tratan cada bit por separado y en procesadores modernos de 64bits se ejecutan
                  las 64 operaciones simultaneamente.
                </li>
                <li>
                  <pre>
                    <code>
            ...
            <div className="section">
              <ol className="list-decimal list-inside mx-5">
                ...
                <li>
                  Los operadores de cambio en Python son un par de digrafos &lt;&lt; y &gt;&gt; sugiriendo claramente en
                  que direccion aplica el cambio.
                </li>
                <li>
                  <pre>
                    <code>
                ...
                <li>
                  Deplazamiento agrega ceros a la derecha y elimina los bits que se desplazan fuera del rango o los bits
                  que se desplazan a la izquierda <br />
                  <pre>
                    <code>
