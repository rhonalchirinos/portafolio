          ...
          <div className="text-justify">
            ...
            <div className="text-justify">
              ...
              <div className="section">
                <p>
                  <b>Lexico: </b> Conjunto de palabras que el lenguaje ofrece a sus usuarios bien sea un lengauje
                  natural o artificial.
                </p>
                <p>
                  <b>Sintaxis:</b> Conjutno de reglas utilizadas para precisar si una determinada cadena de palabras
                  foram una oracion valida.
                </p>
                <pre>
              ...
              <div className="section">
                <ol className="list-decimal list-inside">
                  <li>
                    El interprete lee el codigo fuente de una manera que es comun en la cultura occidental de izquierda
                    a derecha y de arriba hacia abajo.
                  </li>
                  <li>
                    Verifica si todas las lineas subsiguientes son correctas Alfabeticamente, Lexicamente,
                    Sintaticamente y Semanticamente{' '}
                  </li>
                  <li>
                    Comunca errores. <br />
                    Nota: Los lenguajes diseñados para ser utilizados con un interpretador se le llaman lengaujes de
                    scrpting y los programas codificados en dicho lenguaje se les llama scripts.
                  </li>
                </ol>
              </div>
              ...
              <div className="section">
                <ol className="list-decimal list-inside">
                  <li>
                    Los Python 2,3 son mantenidos por Python software Foundation <b>Cpython</b> su prezisdente es Guido
                    van Rossum <b>versiones canonicas</b>{' '}
                  </li>
                  <li>
                    Cython: Extensión de C para Python. Permite escribir codigo en Python con cambios menores que se
                    traducen en lenguaje C logrando un alto rendimiento, utiliza los tipos de datos del lenguaje c/c++
                  </li>
                  <li>
                    Jython: Es un python escrito en Java. Jython puede comunicarse con la infraestructura existente en
                    Java. Hasta la fecha siguien los estandares de python 2 y no tiene hya conforme a Python 3
                  </li>
                  <li>
                    PyPy y RPython: Python escrito en Rpython &quot;Restricted Python&quot;, el cual es un subconjunto
                    de Python. El codigo fuente de pypy no se ejecuta de manera interpretativa si no que se traduce a C
              ...
              <div className="section">
                ...
                <p>
                  <br />
                  Notas: &quot;Hola Mundo&quot; y &quot;Python&quot; son argumentos posicionales, end y sep son
                  argumentos de palabra clave. <br />
                </p>
              </div>
              ...
              <div className="section">
                <p>
                  Un literal se refiere a datos cuyos valores estan determinados por el literal mismo y se utilizan
                  dentro del codigo.
                </p>
              </div>
              ...
              <div className="section">
                <ol className="list-decimal list-inside">
                  <li>
                    Nombre de varaibles y funciones deben estar en minusculas con palabras separadas por guiones bajos
                    para mejorar la legibilidad
                  </li>
                  <li>
                    Tambien es posible usar letras mixtas &quot;myVariable&quot; pero soo en contextos donde ese ya es
              ...
              <div className="section">
                <p>
                  Los bucles while y for tienen una clausula <b>else</b> en python. La clausula <b>else</b> se ejecuta
                  despues que el bucle finalice y cuando no haya terminado con un break
                  <br />
                </p>
              </div>
              ...
              <div className="section">
                <p>
                  Hay cuatro operadores que le permite manipular bits de datos individuales. se denomina operadores bit
                  a bit. <br />
                </p>
                ...
                <ol className="mx-10 list-disc">
                  <li>
                    Los operadores bit a bit tratan cada bit por separado y en procesadores modernos de 64bits se
                    ejecutan las 64 operaciones simultaneamente.
                  </li>
                  <li>
                    <pre>
                      <code>
                        ...
                        <br />
                        bit = i & j
                        <span className="text-gray-400"> # Es una operacion a nivel bit y su resultado s 6</span>
                        <br />
              ...
              <div className="section">
                <ol className="list-decimal list-inside mx-5">
                  ...
                  <li>
                    Los operadores de cambio en Python son un par de digrafos &lt;&lt; y &gt;&gt; sugiriendo claramente
                    en que direccion aplica el cambio.
                  </li>
                  <li>
                    <pre>
                      <code>
                  ...
                  <li>
                    Deplazamiento agrega ceros a la derecha y elimina los bits que se desplazan fuera del rango o los
                    bits que se desplazan a la izquierda <br />
                    <pre>
                      <code>
              ...
              <div className="section">
                <ol className="list-disc mx-8 mt-3">
                  ...
                  <li>
                    <b>insert</b> insertart el elemento en la posicion indicada en caso de no existir la agregade ultimo
                    y realiza un desplazamiento a la derecha.
                  </li>
                  <li>
              ...
              <div className="section">
                <ol className="list-disc mx-8 mt-3">
                  ...
                  <li>
                    <b>insert</b> inserta el elemento en la posición indicada; en caso de no existir, lo agrega al final
                    y realiza un desplazamiento a la derecha.
                  </li>
                  <li>
                    Rebanada: puedes hacer una copia de un arreglo o parte de ella <br />
              ...
              <div className="section">
                <ol className="list-disc mx-8 mt-3">
                  <li>
                    ...
                    excluyendo aquellas que tienen el mismo nombre.
                  </li>
                  <li>
                    <b>Global: </b> existe un método especial de Python el cual puede extender el alcance de una
                    variable incluyendo el cuerpo de las funciones para leer y modificar los valores de las variables.
                    <pre>
                      <code>
                        def my_function(): <br />
                        <span className="ml-5">
                  ...
                  <li>
                    El valor máximo de profundidad de recursión (recursion depth) es 1000, este valor puede ser
                    modificado.
                  </li>
                </ol>
              </div>
              ...
              <div className="section">
                <ol className="list-disc mx-8 mt-3">
                  <li>
                    Tipo de secuencia es un tipo de datos en Python el cual es capaz de almacenar más de un valor o
                    ninguno; si la secuencia varía, los actuales pueden ser secuencialmente examinados.
                  </li>
                  <li>
                    Los datos mutables pueden ser actualizados libremente en cualquier momento &quot;in situ&quot;.
                  </li>
                  <li>
              ...
              <div className="section">
                <ol className="list-disc mx-8 mt-3">
                  ...
                  <li>
                    Para crear una tupla de un solo elemento <code className="codeinline">tupla = (1,)</code> &quot;si
                    se omite la coma será una variable&quot;.
                  </li>
                </ol>
              </div>
              ...
              <div className="section">
                <ol className="list-disc mx-8 mt-3">
                  <li>
                    Es mejor pedir perdón que pedir permiso. Es mejor manejar un error cuando ocurre que tratar de
                    evitarlo.
                  </li>
                  <li>
                    Los argumentos con los cuales instanciamos a dicha clase se guardan en la variable args y esta es de
                    tipo tupla.
                    <pre>
                      <code>
                        try: <br />
              ...
              <div className="section">
                <ol className="list-disc mx-8 mt-3">
                  <li>
                    ...
                    excluyendo aquellas qeu tienen el mismo nombre.
                  </li>
                  <li>
                    <b>Global: </b> existe un metodo expecial de python el cual puede extender el alcance de una
                    variable incluyendo el cuerpo de las funciones para leer y modificar los valores de las variables.
                    <pre>
                      <code>
                        def my_function(): <br />
                  ...
                  <li>
                    El valor maximo de profundida de recursion. (recursion depth) es 1000, este valor puede ser
                    modificado.
                  </li>
                </ol>
              </div>
              ...
              <div className="section">
                <ol className="list-disc mx-8 mt-3">
                  <li>
                    Tipo de secuencia es un tipo de datos en Python el caul es capaz de almacenar mas de un valor o
                    ninguno, si la secuencia esta varia los acuales pueden ser secuencialmente examinados.
                  </li>
                  <li>
                    Los datos mutables pueden ser actualizados libremente en cualquier momento &quot;in situ&quot;
                  </li>
              ...
              <div className="section">
                <ol className="list-disc mx-8 mt-3">
                  ...
                  <li>
                    Para crear una tupla de un solo elemento <code className="codeinline">tupla = (1,)</code> &quot;si
                    se omite la coma sera una variable&quot;
                  </li>
                </ol>
              </div>
              ...
              <div className="section">
                <ol className="list-disc mx-8 mt-3">
                  <li>
                    Es mejor pedir perdon que perdir permiso, Es mejor manejar un error cuando ocurre que tratar de
                    evitarlo
                  </li>
                  <li>
                    Los argumentos con los cuales instanciamos a dicha clase se guarda en la variable args y esta es de
                    tipo tupla
                    <pre>
                      <code>
                        try: <br />
