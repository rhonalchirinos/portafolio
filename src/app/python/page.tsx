            ...
            <div className="relative isolate px-4 pt-6">
                <div className="py-16">
                    <div className="text-justify">
                        ...
                        <p className="mt-4">
                            ¿Por que deberia aprender Python ? Por que es omnipresente, multiplataforma, facil de
                            aprender y por que necesitamos pagar facturas.
                        </p>

                        <div className="text-justify">
                            <h3 className="title"> Fundamentos de Programación. </h3>
                            <div className="section">
                                <p>
                                    <b>Lexico: </b> Conjunto de palabras que el lenguaje ofrece a sus usuarios bien sea
                                    un lengauje natural o artificial.
                                </p>
                                <p>
                                    <b>Sintaxis:</b> Conjutno de reglas utilizadas para precisar si una determinada
                                    cadena de palabras foram una oracion valida.
                                </p>
                                <pre>
                            ...
                            <div className="section">
                                <ol className="list-decimal list-inside">
                                    <li>
                                        El interprete lee el codigo fuente de una manera que es comun en la cultura
                                        occidental de izquierda a derecha y de arriba hacia abajo.
                                    </li>
                                    <li>
                                        Verifica si todas las lineas subsiguientes son correctas Alfabeticamente,
                                        Lexicamente, Sintaticamente y Semanticamente{' '}
                                    </li>
                                    <li>
                                        Comunca errores. <br />
                                        Nota: Los lenguajes diseñados para ser utilizados con un interpretador se le
                                        llaman lengaujes de scrpting y los programas codificados en dicho lenguaje se
                                        les llama scripts.
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div className="section">
                                <ol className="list-decimal list-inside">
                                    <li>
                                        Los Python 2,3 son mantenidos por Python software Foundation <b>Cpython</b> su
                                        prezisdente es Guido van Rossum <b>versiones canonicas</b>{' '}
                                    </li>
                                    <li>
                                        Cython: Extensión de C para Python. Permite escribir codigo en Python con
                                        cambios menores que se traducen en lenguaje C logrando un alto rendimiento,
                                        utiliza los tipos de datos del lenguaje c/c++
                                    </li>
                                    <li>
                                        Jython: Es un python escrito en Java. Jython puede comunicarse con la
                                        infraestructura existente en Java. Hasta la fecha siguien los estandares de
                                    ...
                                    <li>
                                        ...
                                        <ol>
                                            ...
                                            <li>
                                                La velocidad de Pypy es sensiblemente superior al a del interprete de
                                                Cpython
                                            </li>
                                            <li>Es disponible para Python 2 y 3</li>
                                            <li>
                                                Compatibilidad con funcionalidad core, La mayoria de los modulos
                                                estandar pero no con todas las librerias
                                            </li>
                                        </ol>
                                    </li>
                                </ol>
                            ...
                            <div className="section">
                                <p>
                                    Un literal se refiere a datos cuyos valores estan determinados por el literal mismo
                                    y se utilizan dentro del codigo.
                                </p>
                            </div>
                            ...
                            <div className="section">
                                <ol className="list-decimal list-inside">
                                    <li>
                                        Python 3.6 ha introduccion el guion bajo en los literales numericos para manejar
                                        la legibilidad <b>11_111_111</b>
                                    </li>
                                    <li>
                                        Los numeros positivos no requieren un signo positivo antepuesto, per es
                                        permitido
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <pre>
                                            <code>
                                                ...
                                                <br />
                                                1E-22=1x10^-22 = 0.0000000000000000000001 # masa de un electron,
                                                constante de Plock
                                            </code>
                                        </pre>
                                    </li>
                            ...
                            <div className="section">
                                <ol className="list-decimal list-inside">
                                    <li>
                                        Exponenciacion:
                                        <code className="codeinline m-1">2**4</code> donde 2 es la base y 4 el
                                        exponente. <br />
                                        Notas:
                                        <ul className="list-disc px-10">
                                            ...
                                            <li>
                                                En caso de que uno de los argumentos sea flotante el resultado es
                                                flotante
                                            </li>
                                            <li>
                            ...
                            <div className="section">
                                <ol className="list-decimal list-inside">
                                    ...
                                    <li>
                                        Python no solo soporta alfabeto latino si no caracteres especificos de otros
                                        alfabetos
                                    </li>
                            ...
                            <div className="section">
                                <ol className="list-decimal list-inside">
                                    <li>
                                        Nombre de varaibles y funciones deben estar en minusculas con palabras separadas
                            ...
                            <div className="section">
                                <p>
                                    Los bucles while y for tienen una clausula <b>else</b> en python. La clausula{' '}
                                    <b>else</b> se ejecuta despues que el bucle finalice y cuando no haya terminado con
                                    un break
                                    <br />
                                </p>
                            </div>
                            ...
                            <div className="section">
                                <p>
                                    Hay cuatro operadores que le permite manipular bits de datos individuales. se
                                    denomina operadores bit a bit. <br />
                                </p>
                                ...
                                <ol className="mx-10 list-disc">
                                    <li>
                                        Los operadores bit a bit tratan cada bit por separado y en procesadores modernos
                                        de 64bits se ejecutan las 64 operaciones simultaneamente.
                                    </li>
                                    <li>
                                        <pre>
                                            <code>
                                                ...
                                                <span className="text-gray-400">
                                                    #Operacion logica y su resultado es True
                                                </span>
                                                <br />
                                                bit = i & j
                                                <span className="text-gray-400">
                                                    {' '}
                                                    # Es una operacion a nivel bit y su resultado s 6
                                                </span>
                                                <br />
                                                logneg = not i
                                                <span className="text-gray-400"> # Operacion logica valor False</span>
                                                bitneg = ~ i
                                                <span className="text-gray-400">
                                                    {' '}
                                                    # Operacion a nivel de bit y su valor es -16
                                                </span>
                                            </code>
                                        </pre>
                                    </li>
                            ...
                            <div className="section">
                                <ol className="list-decimal list-inside mx-5">
                                    ...
                                    <li>
                                        ...
                                        sugiriendo claramente en que direccion aplica el cambio.
                                    </li>
                                    <li>
                                        <pre>
                                            <code>
                                    ...
                                    <li>
                                        Deplazamiento agrega ceros a la derecha y elimina los bits que se desplazan
                                        fuera del rango o los bits que se desplazan a la izquierda <br />
                                        <pre>
                                            <code>
                            ...
                            <div className="section">
                                <ol className="list-disc mx-8 mt-3">
                                    ...
                                    <li>
                                        <b>insert</b> insertart el elemento en la posicion indicada en caso de no
                                        existir la agregade ultimo y realiza un desplazamiento a la derecha.
                                    </li>
                                    <li>
                                        Rebanada: puedes hacer una copia de un arreglo o parte de ella <br />
                                        <ol>
                                            <li>
                                                <b>start:</b> indica el indice del primer elemento incluido en la
                                                rebanada
                                            </li>
                                            <li>
                                                <b>end:</b> indica el indice del primer elemento no incluido en la
                                                rebanada
                                                <pre>
                                                    <code>
                                                        arr = [10,8,6,4,2] <br />
                                            ...
                                            <li>
                                                Si <b>start</b> especifica un elemento superior a <b>end</b> la lista es
                                                vacia.
                                            </li>
                                        </ol>
                                        <pre>
                                            <code>
                                                lista2 = lista[:]
                                                <span className="text-gray-400"> # produce una nueva lista </span>{' '}
                                                <br />
                                                my_lista[start:end]
                                                <span className="text-gray-400">
                                                    {' '}
                                                    # crea una nueva lista de destino tomando elementos de la lista
                                                    origen.
                                                </span>
                                            </code>
                                        </pre>
                            ...
                            <div className="section">
                                <ol className="list-disc mx-8 mt-3">
                                    ...
                                    <li>
                                        <b>insert</b> inserta el elemento en la posición indicada; en caso de no
                                        existir, lo agrega al final y realiza un desplazamiento a la derecha.
                                    </li>
                                    <li>
                                        Rebanada: puedes hacer una copia de un arreglo o parte de ella <br />
                                        <ol>
                                            <li>
                                                <b>start:</b> indica el índice del primer elemento incluido en la
                                                rebanada
                                            </li>
                                            <li>
                                                <b>end:</b> indica el índice del primer elemento no incluido en la
                                                rebanada
                                                <pre>
                                                    <code>
                                                        arr = [10,8,6,4,2] <br />
                                            ...
                                            <li>
                                                Si <b>start</b> especifica un elemento superior a <b>end</b>, la lista
                                                es vacía.
                                            </li>
                                        </ol>
                                        <pre>
                            ...
                            <div className="section">
                                <ol className="list-disc mx-8 mt-3">
                                    <li>
                                        Una variable que existe fuera de una función tiene alcance dentro del cuerpo de
                                        la función, excluyendo aquellas que tienen el mismo nombre.
                                    </li>
                                    <li>
                                        <b>Global: </b> existe un método especial de Python el cual puede extender el
                                        alcance de una variable incluyendo el cuerpo de las funciones para leer y
                                    ...
                                    <li>
                                        El valor máximo de profundidad de recursión (recursion depth) es 1000, este
                            ...
                            <div className="section">
                                <ol className="list-disc mx-8 mt-3">
                                    <li>
                                        Tipo de secuencia es un tipo de datos en Python el cual es capaz de almacenar
                                        más de un valor o ninguno; si la secuencia varía, los actuales pueden ser
                            ...
                            <div className="section">
                                <ol className="list-disc mx-8 mt-3">
                                    <li>
                                        Es mejor pedir perdón que pedir permiso. Es mejor manejar un error cuando ocurre
                                        que tratar de evitarlo.
                                    </li>
                                    <li>
                                        Los argumentos con los cuales instanciamos a dicha clase se guardan en la
                                        variable args y esta es de tipo tupla.
                                        <pre>
                                            <code>
                                                try: <br />
                            ...
                            <div className="section">
                                <ol className="list-disc mx-8 mt-3">
                                    <li>
                                        Una variable que existe fuera de una funcion tiene alcance dentro del cuerpo de
                                        la funcion excluyendo aquellas qeu tienen el mismo nombre.
                                    </li>
                                    <li>
                                        <b>Global: </b> existe un metodo expecial de python el cual puede extender el
                                        alcance de una variable incluyendo el cuerpo de las funciones para leer y
                                        modificar los valores de las variables.
                                        <pre>
                                            <code>
                                    ...
                                    <li>
                                        El valor maximo de profundida de recursion. (recursion depth) es 1000, este
                                        valor puede ser modificado.
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div className="section">
                                <ol className="list-disc mx-8 mt-3">
                                    <li>
                                        Tipo de secuencia es un tipo de datos en Python el caul es capaz de almacenar
                                        mas de un valor o ninguno, si la secuencia esta varia los acuales pueden ser
                                        secuencialmente examinados.
                                    </li>
                                    <li>
                                        Los datos mutables pueden ser actualizados libremente en cualquier momento
                            ...
                            <div className="section">
                                <ol className="list-disc mx-8 mt-3">
                                    <li>
                                        Es mejor pedir perdon que perdir permiso, Es mejor manejar un error cuando
                                        ocurre que tratar de evitarlo
                                    </li>
                                    <li>
                                        Los argumentos con los cuales instanciamos a dicha clase se guarda en la
                                        variable args y esta es de tipo tupla
                                        <pre>
                                            <code>
                                                try: <br />
