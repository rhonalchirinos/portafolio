...
type DockerEditorialArchiveSectionProps = {
  language: Language
  publications: Publication[]
}

export function DockerEditorialArchiveSection({ language, publications }: DockerEditorialArchiveSectionProps) {
  return (
